...
FLICKR_API_KEY = os.environ['COMMUNITY_FLICKR_API_KEY']
FLICKR_SECRET = os.environ['COMMUNITY_FLICKR_SECRET']
...
ROOT_URLCONF = 'collage_donation.client.flickr_web_client.webapp_urls'
