...
class Vector(object):
    """An abstract class for an vector that can be embedded with message data.
    
    This class is immutable; encoding and decoding should create a new vector.
...
class VectorProvider(object):
    """Provider of unembedded vectors (e.g., images, tweets).
    
    Applications must implement the _find_vector method of this class.
